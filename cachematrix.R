...
## the cacheSolve function uses the MASS library to calculate the inverse of a matrix
## within the makeCacheMatrix function, once it has not been previously calculated 
